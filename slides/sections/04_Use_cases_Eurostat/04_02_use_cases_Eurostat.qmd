...
- Gérer l'aspect "proxy" des donnés `OJA` et le fait qu'il manque beaucoup d'offres non publiées en ligne
...
## [Online-Based Enterprise Characteristics](https://ec.europa.eu/eurostat/cros/content/WPC_Overview_en#Milestones_and_deliverables)
