...
Mettre box 
Exemple en python avec param user-agent dans request

## Les guidelines du SSE : suivre les conventions
...
- Ajouter des pauses entre chaque requête, pour ne pas aller plus vite qu'un utilisateur ne le pourrait (`time.sleep()` en `Python` <i class="fa-brands fa-python"></i>)
