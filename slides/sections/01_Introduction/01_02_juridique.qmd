...
- Consciemment déroger aux règlementations données et manquer de transparence

- Surcharger les requêtes sur le site concerné (assimilable à une attaque DDoS) ou multiplier les mêmes requêtes plusieurs fois
...
- Dans le doute, ne pas hésiter à se renseigner davantage.
