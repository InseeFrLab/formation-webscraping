...
- Les articles discutant de webscraping et de leur légalité sont tout aussi proliférant, mais pas toujours d'accord les uns avec les autres.
...
- Certains règlements et directives relatifs à la protection des bases de données en Europe
    - [Directive 96/9/CE] du Parlement Européen et du conseil(https://eur-lex.europa.eu/LexUriServ/LexUriServ.do?uri=CELEX:31996L0009:fr:HTML)
...
- Étaler les requêtes en laissant un temps de 'pause' entre chaque requête sur site
